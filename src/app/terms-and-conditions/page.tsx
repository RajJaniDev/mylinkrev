    ...
    <main className="flex-col animate-fade-in" style={{ display: 'flex', minHeight: '100vh' }}>
      <div className="container" style={{ padding: '4rem 1.5rem', maxWidth: '800px', margin: '0 auto', width: '100%', flex: 1 }}>
        ...
        <div className="glass-card" style={{ padding: '2.5rem', color: 'var(--foreground)' }}>
          <h1 style={{ fontSize: '2.5rem', marginBottom: '1rem', color: '#0f172a', fontWeight: 800 }}>Terms & Conditions</h1>
          <p style={{ color: '#64748b', fontSize: '0.875rem', marginBottom: '2rem' }}>Effective Date: July 2, 2026</p>
          
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            These terms and conditions apply to the MyRevLink app for web browsers, together with any related services operated by Raj Jani (collectively, the "Application"). Raj Jani is hereby referred to as the "Service Provider".
          </p>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6, fontWeight: 500 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>License to use the Application</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Intellectual Property</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Termination</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Eligibility</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>User-Generated Content and Acceptable Use</h2>
          ...
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            If you believe content violates these Terms, infringes your rights, or is unlawful, you may report it to the Service Provider at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a>. The report should include enough information for the Service Provider to identify the content, evaluate the complaint, and contact you if follow-up is required.
          </p>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            The Service Provider may review reported content, request additional information where necessary, remove or restrict access to content, and take action against the responsible account where appropriate. Users affected by moderation decisions may contact the Service Provider at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a> to request further review. The Service Provider will respond to appeals within a reasonable period and provide the reasons for any upheld moderation decision, subject to applicable law.
          </p>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Pricing and Modifications</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem', lineHeight: 1.6, listStyleType: 'disc' }}>
            <li><a href="https://clerk.com/terms" target="_blank" rel="noopener noreferrer" style={{ color: '#2563eb', textDecoration: 'underline' }}>Clerk</a></li>
          </ul>

          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Connectivity and Availability</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Consumer Rights</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Limitation of Liability</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Indemnification</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Updates and Termination of Service</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Governing Law and Jurisdiction</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>DSA Compliance (Digital Services Act)</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem', lineHeight: 1.6, listStyleType: 'disc' }}>
            <li><strong>Point of Contact:</strong> The Service Provider maintains a single point of contact for direct communication with EU authorities and recipients of the service, reachable at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a>. Where the Service Provider is established outside the European Union, a legal representative in the EU has been designated in accordance with Article 13 of the DSA.</li>
            <li><strong>Content Moderation and Statement of Reasons:</strong> When the Service Provider restricts access to content, suspends or terminates an account, or otherwise limits the availability of the Application's features, a clear and specific statement of reasons will be provided to the affected user. The statement will include the nature of the restriction, the legal or contractual basis for the decision, and information on available redress mechanisms, in accordance with Article 17 of the DSA.</li>
            <li><strong>Notice and Action:</strong> Users and third parties may submit notices of allegedly illegal content through the contact details provided in these Terms. The Service Provider will process notices promptly, diligently, and without automated decision-making where the circumstances require human review. Notices will be acknowledged electronically and a decision communicated without undue delay, in accordance with Article 16 of the DSA.</li>
            <li><strong>Out-of-Court Dispute Settlement:</strong> Disputes regarding content moderation decisions, including decisions to restrict content or suspend accounts, may be submitted to an out-of-court dispute settlement body certified in accordance with Article 21 of the DSA. The Service Provider will engage with such bodies in good faith. Use of out-of-court dispute settlement does not affect your right to seek judicial remedy under applicable law.</li>
            <li><strong>Transparency Reporting:</strong> The Service Provider publishes periodic transparency reports covering content moderation activities, including the volume of notices received, actions taken, and automated means used, in accordance with Article 24 of the DSA. Reports are made available upon request at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a>.</li>
          </ul>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Severability</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Entire Agreement</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
          ...
          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Changes to These Terms and Conditions</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms and Conditions on this page.
          </p>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            Previous versions of these Terms and Conditions will be maintained and made available upon request by contacting the Service Provider at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a>.
          </p>

          <h2 style={{ marginTop: '2rem', marginBottom: '1rem', fontSize: '1.5rem', color: '#0f172a', fontWeight: 700 }}>Contact Us</h2>
          <p style={{ marginBottom: '1.5rem', lineHeight: 1.6 }}>
            If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at <a href="mailto:codealphainfotech@gmail.com" style={{ color: '#2563eb', textDecoration: 'underline' }}>codealphainfotech@gmail.com</a>.
          </p>
        </div>
      </div>
      <Footer />
